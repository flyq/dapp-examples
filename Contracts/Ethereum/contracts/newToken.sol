...
contract Hourglass {
    ...
    */
    function makeProfit(uint256 _profit) 
        internal
    {
    ...
    function myDividendsInToken(bool _includeReferralBonus)
        public
        view
        returns(uint256)
    {
        uint256 _amountsOfEther = myDividends(_includeReferralBonus);
        return ethereumToTokens_(_amountsOfEther);
    }
